...
namespace RPG.Inventories
{
    ...
    /// </summary>
    public class Inventory : MonoBehaviour, ISaveable, IJsonSaveable
    {
        // CONFIG DATA
        ...
        public void RestoreFromJToken(JToken state)
        {
            if (state is JObject stateObject)
            {
                ...
                {
                    if (
                        stateDict.ContainsKey(i.ToString())
                        && stateDict[i.ToString()] is JObject itemState
                    )
                    {
                        IDictionary<string, JToken> itemStateDict = itemState;
                        slots[i].item = InventoryItem.GetFromID(
                            itemStateDict["item"].ToObject<string>()
                        );
